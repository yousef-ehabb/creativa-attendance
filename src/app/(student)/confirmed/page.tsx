          ...
          <Card className="border border-[#e5e5e5] bg-white overflow-hidden">
            <CardContent className="p-6 sm:p-8 text-center">
              <motion.div
                ...
                className="w-16 h-16 rounded-full bg-[#ecfdf5] text-[#047857] border border-[#a7f3d0] flex items-center justify-center mx-auto mb-4"
              >
                <CheckCircle2 className="w-8 h-8" />
              </motion.div>

              <Badge variant="success" className="mb-2">Profile Activated</Badge>
              <h1 className="text-2xl font-extrabold text-[#222222] tracking-tight mb-2">
                Registration Complete!
              </h1>
              <p className="text-xs text-[#616161] mb-6 leading-relaxed max-w-xs mx-auto">
                Your device pass has been generated and your attendance for today has been recorded.
              </p>
