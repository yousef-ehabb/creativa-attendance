...
<reference>
@D:/Work/Creativa/creativa-attendance/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `D:/Work/Creativa/creativa-attendance/.claude/get-shit-done/references/user-profiling.md` to load:
