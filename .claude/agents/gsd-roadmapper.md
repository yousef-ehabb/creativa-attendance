...
Reference full template: `D:/Work/Creativa/creativa-attendance/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `D:/Work/Creativa/creativa-attendance/.claude/get-shit-done/templates/state.md`.
