...
<required_reading>
@D:/Work/Creativa/creativa-attendance/.claude/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@D:/Work/Creativa/creativa-attendance/.claude/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = D:/Work/Creativa/creativa-attendance/.claude
                  → checks D:/Work/Creativa/creativa-attendance/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = D:/Work/Creativa/creativa-attendance/.claude/get-shit-done
                  → writes to D:/Work/Creativa/creativa-attendance/.claude/get-shit-done/hooks/
...
@D:/Work/Creativa/creativa-attendance/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @D:/Work/Creativa/creativa-attendance/.claude/get-shit-done/references/common-bug-patterns.md
