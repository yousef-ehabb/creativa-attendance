...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `D:/Work/Creativa/creativa-attendance/.claude/skills/.gsd-surface.json`
...
```bash
# Claude Code
RUNTIME_CONFIG_DIR=D:/Work/Creativa/creativa-attendance/.claude/skills

# Resolve commandsDir and agentsDir
COMMANDS_DIR=D:/Work/Creativa/creativa-attendance/.claude/commands/gsd
AGENTS_DIR=D:/Work/Creativa/creativa-attendance/.claude/agents
```
...
<execution_context>
Surface state file: `D:/Work/Creativa/creativa-attendance/.claude/skills/.gsd-surface.json`
Install profile marker: `D:/Work/Creativa/creativa-attendance/.claude/skills/.gsd-profile`
Engine module: `D:/Work/Creativa/creativa-attendance/.claude/get-shit-done/bin/lib/surface.cjs`
Cluster definitions: `D:/Work/Creativa/creativa-attendance/.claude/get-shit-done/bin/lib/clusters.cjs`
</execution_context>
