...
- Usage: Reference from command with `@D:/Work/Creativa/creativa-attendance/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to D:/Work/Creativa/creativa-attendance/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to D:/Work/Creativa/creativa-attendance/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
