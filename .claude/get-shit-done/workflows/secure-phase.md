...
```
Agent(
  prompt="Read D:/Work/Creativa/creativa-attendance/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `D:/Work/Creativa/creativa-attendance/.claude/get-shit-done/templates/SECURITY.md`
