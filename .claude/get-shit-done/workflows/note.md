...
- **Global scope**: `D:/Work/Creativa/creativa-attendance/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `D:/Work/Creativa/creativa-attendance/.claude/notes/`)
...
2. Glob `D:/Work/Creativa/creativa-attendance/.claude/notes/*.md` (if directory exists) — global notes
...
Global (D:/Work/Creativa/creativa-attendance/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `D:/Work/Creativa/creativa-attendance/.claude/notes/` — works in any directory
