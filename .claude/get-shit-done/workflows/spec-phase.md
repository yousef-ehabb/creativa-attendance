...
```bash
INIT=$(node "D:/Work/Creativa/creativa-attendance/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @D:/Work/Creativa/creativa-attendance/.claude/get-shit-done/templates/spec.md.
