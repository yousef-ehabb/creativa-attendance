...
```markdown
Read D:/Work/Creativa/creativa-attendance/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: D:/Work/Creativa/creativa-attendance/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read D:/Work/Creativa/creativa-attendance/.claude/agents/gsd-ui-checker.md for instructions.
