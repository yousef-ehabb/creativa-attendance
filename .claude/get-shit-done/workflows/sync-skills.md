...
INSTALL_JS_GLOBAL="D:/Work/Creativa/creativa-attendance/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node D:/Work/Creativa/creativa-attendance/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
